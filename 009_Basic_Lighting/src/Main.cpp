...
//adjusted as well this is a callback to do that
    ...
    geometryShader.setFloat("ambientStrength", AMBIENT_STRENGTH);
    geometryShader.setFloat("specularStrength", SPECULAR_STRENGTH);
    geometryShader.setVec3("lightColor", LIGHT_COLOR);
    geometryShader.setVec3("lightPos", lightPos);
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        lightPos+=offsetLightPos;
        lightModel = glm::translate(lightModel, offsetLightPos);
