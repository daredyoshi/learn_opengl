...
{    
    ...
    // -------------------------
    std::string geometryShaderPath = CWD + "shaders/vert/geometry.glsl";
    std::string redShaderPath = CWD + "shaders/frag/red.glsl";
    std::string greenShaderPath = CWD + "/shaders/frag/green.glsl";
    std::string blueShaderPath = CWD + "/shaders/frag/blue.glsl";
    std::string yellowShaderPath = CWD + "/shaders/frag/yellow.glsl";
    ShaderProgram shaderRed(geometryShaderPath, redShaderPath);
    ShaderProgram shaderGreen(geometryShaderPath, greenShaderPath);
    ShaderProgram shaderBlue(geometryShaderPath, blueShaderPath);
    ShaderProgram shaderYellow(geometryShaderPath, yellowShaderPath);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shaderRed.setMatrix("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        // GREEN
        shaderGreen.use();
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.75f, 0.75f, 0.0f)); // move top-right
        shaderGreen.setMatrix("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        // YELLOW
        shaderYellow.use();
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.75f, -0.75f, 0.0f)); // move bottom-left
        shaderYellow.setMatrix("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        // BLUE
        shaderBlue.use();
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.75f, -0.75f, 0.0f)); // move bottom-right
        shaderBlue.setMatrix("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
