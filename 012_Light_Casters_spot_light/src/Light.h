...
public:
    SpotLight(
        ...
        PointLight(ambient, diffuse, specular, position, linear, quadratic),
        m_direction{direction},
        m_cutoff{cutoff},
    ...
    virtual void setShaderMaterial(const ShaderProgram& shader) const override {
        ...
        shader.setFloat("light.cutoff", glm::cos(glm::radians(m_cutoff)));
        shader.setFloat("light.outerCutoff", glm::cos(glm::radians(m_outerCutoff)));
    }
