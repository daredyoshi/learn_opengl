...
void AssimpModel::loadModel(std::string_view path){
...
Mesh AssimpModel::processMesh(const aiMesh *mesh, const aiScene *scene){
...
Texture AssimpModel::loadMaterialTextures(aiMaterial *mat, aiTextureType type, unsigned int idx){
    Texture texture{};
